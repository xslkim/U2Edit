...
> 版本: v0.9
> 日期: 2026-04-15
> 状态: 草案（已根据 review 修订 — 第三轮）
>
> v0.9 修订：2.2 网格步长补齐为 10/50/100px 三档（与 tasks.md T1.8 对齐）
...
| 网格与参考线 | 可选显示对齐网格（Ctrl+G 切换）。网格步长按当前缩放分三档自动切换：缩放 ≥ 200% 时 10px、50% ~ 200% 时 50px、< 50% 时 100px |
